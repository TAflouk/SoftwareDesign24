...
public class DeliveryDriver{
		...
		public String toString() {
			return "DeliveryDriver [id=" + id + ", name=" + name + ", surname=" + surname + ", phoneNumber="
					+ phoneNumber + ", Address=" + Address + ", pin=" + pin + ", resetPinOptionVisible="
					+ resetPinOptionVisible + ", loginWindowDisplayed=" + loginWindowDisplayed + "]";
		}
        ...
        public boolean verifyAddress(String address) throws NewsagentExceptionHandler {
            ...
            // Allow letters, digits, commas, spaces, ampersands, and hyphens in the address
            if (address.matches("^[a-zA-Z0-9, & -]+$") && address != null && !address.isEmpty() ) 
            {
                return true;
            } else {
